...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@frelion/bone-coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@frelion/bone-tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "@frelion/bone-tui";
