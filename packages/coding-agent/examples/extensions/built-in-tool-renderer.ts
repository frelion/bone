...
import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "@frelion/bone-coding-agent";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "@frelion/bone-coding-agent";
