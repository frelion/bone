...
import { complete, type Message } from "@frelion/bone-ai/compat";
import type { ExtensionAPI, SessionEntry } from "@frelion/bone-coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@frelion/bone-coding-agent";
