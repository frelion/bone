...
```
~/.bone/agent/sessions/--<path>--/<timestamp>_<uuid>.jsonl
```
...
Sessions can be removed by deleting their `.jsonl` files under `~/.bone/agent/sessions/`.
...
Source on GitHub ([pi-mono](https://github.com/frelion/bone)):
- [`packages/coding-agent/src/core/session-manager.ts`](https://github.com/frelion/bone/blob/main/packages/coding-agent/src/core/session-manager.ts) - Session entry types and SessionManager
- [`packages/coding-agent/src/core/messages.ts`](https://github.com/frelion/bone/blob/main/packages/coding-agent/src/core/messages.ts) - Extended message types (BashExecutionMessage, CustomMessage, etc.)
- [`packages/ai/src/types.ts`](https://github.com/frelion/bone/blob/main/packages/ai/src/types.ts) - Base message types (UserMessage, AssistantMessage, ToolResultMessage)
- [`packages/agent/src/types.ts`](https://github.com/frelion/bone/blob/main/packages/agent/src/types.ts) - AgentMessage union type

For TypeScript definitions in your project, inspect `node_modules/@frelion/bone-coding-agent/dist/` and `node_modules/@frelion/bone-ai/dist/`.
