...
export interface Settings {
	...
	httpIdleTimeoutMs?: number; // Provider request and semantic-event idle timeout in milliseconds; 0 disables it
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.BONE_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.BONE_HARDWARE_CURSOR === "1";
	}
