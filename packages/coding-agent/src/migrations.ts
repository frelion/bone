...
const MIGRATION_GUIDE_URL =
	"https://github.com/frelion/bone/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/frelion/bone/blob/main/packages/coding-agent/docs/extensions.md";
