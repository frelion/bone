...
export class TUI extends Container {
	...
	private showHardwareCursor = process.env.BONE_HARDWARE_CURSOR === "1";
	private clearOnShrink = process.env.BONE_CLEAR_ON_SHRINK === "1"; // Clear empty rows when content shrinks (default: off)
	...
	private doRender(): void {
		...
		const debugRedraw = process.env.BONE_DEBUG_REDRAW === "1";
		...
		// Configurable via setClearOnShrink() or BONE_CLEAR_ON_SHRINK=0 env var
		...
		if (process.env.BONE_TUI_DEBUG === "1") {
