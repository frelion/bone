...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".bone/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".bone/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.bone/agent/sessions)
