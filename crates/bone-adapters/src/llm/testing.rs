...
{
    crate::llm::protocol::openai_responses::from_client(endpoint_id, client)
}
...
where
    H: HttpClientExt + Clone + Default + Debug + Send + Sync + 'static,
{
    crate::llm::protocol::openai_chat_completions::from_client(endpoint_id, client)
}
...
{
    crate::llm::protocol::anthropic_messages::from_client(endpoint_id, client)
}
...
where
    H: HttpClientExt
        ...
        + 'static,
{
    crate::llm::service::chatgpt_subscription::from_unmanaged_client(endpoint_id, client)
}
