...
use crate::tools::{ToolEnvironment, ToolError, workspace::ResolvedPath};
...
mod tests {
    ...
    async fn failed_restore_retains_a_recovery_file_without_model_path_leakage() {
        ...
        assert_eq!(
            ...
            &crate::llm::ToolOutput::text("apply patch rollback failed for original.txt")
        );
    ...
    async fn rejects_workspace_escape_before_writing() {
        ...
        let outside = temp
            ...
            .parent()
            .unwrap()
            .join("bone-adapters-patch-escape.txt");
        let result = tool(temp.path())
            .call(ApplyPatchArgs {
                patch: "*** Begin Patch\n*** Add File: ../bone-adapters-patch-escape.txt\n+secret\n*** End Patch"
                    .to_owned(),
            })
            .await;
