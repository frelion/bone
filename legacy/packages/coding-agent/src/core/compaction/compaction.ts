...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@frelion/bone-agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@frelion/bone-ai";
...
async function completeSummarization(
	...
	if (!streamFn) {
		throw new Error("A stream function is required for summarization");
	}
