...
import { createHarness, getUserTexts, type Harness, stageResponse } from "../harness.ts";
...
describe("regression #6363: agent settled event and idle waiting", () => {
	...
	it("extension command waitForIdle waits for session-level settlement", async () => {
		...
		harness.setResponses([
			stageResponse("I will wait for the command to observe settlement.", "Waiting for settlement"),
