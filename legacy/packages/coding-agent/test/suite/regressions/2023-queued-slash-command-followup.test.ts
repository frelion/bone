...
import { createHarness, getAssistantTexts, getUserTexts, type Harness, stageResponse } from "../harness.ts";
...
describe("issue #2023 queued slash-command follow-up", () => {
	...
	it("treats extension-origin queued slash-command follow-ups as raw user text instead of dispatching the command", async () => {
		...
		harness.setResponses([
			stageResponse("I will wait while the follow-up is queued.", "Waiting for the queued follow-up"),
