...
import type { AgentMessage, AgentToolResult } from "@frelion/bone-agent-core";
	...
	it("normalizes tool results from untyped tools that omit content", async () => {
		...
		try {
			harness.setResponses([
				stageResponse("I will search and normalize the extension result.", "Searching with the extension tool"),
