# @frelion/bone-agent-core

Stateful agent with tool execution and event streaming. Built on `@frelion/bone-ai`.
...
```typescript
declare module "@frelion/bone-agent-core" {
...
```typescript
import { Agent, streamProxy } from "@frelion/bone-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@frelion/bone-agent-core";
