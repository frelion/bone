 ...
 *
 * Test-only compatibility helpers for exercising legacy behavior. Production
 * code uses `createModels()` and provider factories; this module is not part of
 * the package exports.
 */
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@frelion/bone-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@frelion/bone-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@frelion/bone-ai/providers/all" or `Models.getProviders()`. */
