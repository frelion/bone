...
Download the executable for your platform from [GitHub Releases](https://github.com/frelion/bone/releases)
and place it on your `PATH`. On macOS/Linux, make it executable after downloading:
...
The GitHub Release files are standalone Bun executables and do not
