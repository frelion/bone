import { createAssistantMessageEventStream, Type } from "@frelion/bone-ai";
import { builtinModels, getBuiltinModel, getBuiltinProviders } from "@frelion/bone-ai/providers/all";
import {
	Agent,
	bashExecutionToText,
	convertToLlm,
...
console.log(
	model.id,
	getBuiltinProviders().length,
	typeof models.complete,
	schema.type,
	typeof stream.push,
